...
public class GetResponse {
    ...
    public GetResponse shouldReturn200(String url) throws IOException {
        this.url.append(url);
        client = buildClient();
    ...
    public GetResponse shouldReturn200() throws IOException {
        client = buildClient();
    ...
    public GetResponse shouldHaveHeader(String headerName) throws IOException {
        client = buildClient();
    ...
    public GetResponse shouldHaveHeader(String url, String headerName) throws IOException {
        client = buildClient();
    ...
    public GetResponse shouldHaveHeaders(String ...headersNames) throws IOException {
        client = buildClient();
    ...
    public GetResponse ofThisUrl(String url){
        this.url.append(url);
        return this;
    }
...
//        System.out.println(EntityUtils.toString(this.response.getEntity()));
    ...
    public GetResponse getJson() throws IOException {
        jsonBody = new StringBuilder();
        client = buildClient();
